...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [{
      ...
      name: 'Overview',
      meta: { title: '总览', icon: 'home', affix: false }
    }]
  },
  // {
  //   // path: '/exception',
    ...
    children: [
      {
        ...
        name: 'Exception',
        meta: { title: '异常监控', icon: 'error', affix: false }
      }
    ]
  },
  {
    ...
    alwaysShow: true, // 一直显示根路由
    meta: { title: '性能监控', icon: 'power' },
    children: [
      {
        path: 'index',
        component: () => import('@/views/keydata/index'),
        name: 'KeyData',
        meta: { title: '数据统计', icon: 'chart', affix: false }
      },
      {
        path: 'detail',
        component: () => import('@/views/keydata/detail'),
        name: 'Detail',
        meta: { title: '详情', icon: 'form', affix: false }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'UserAction',
        meta: { title: '用户行为数据', icon: 'user', affix: false }
      }
    ]
  }
]
